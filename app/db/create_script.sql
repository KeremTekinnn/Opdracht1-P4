    ...
    VALUES
        ...
        ,('TR-24-OP', 'DAF', '2019-05-23', 'Diesel', 1, 1, NULL, SYSDATE(6), SYSDATE(6))
        ...
        ,('34-TK-LP', 'Scania', '2015-03-13', 'Diesel', 1, 1, NULL, SYSDATE(6), SYSDATE(6))
        ,('YY-OP-78', 'BMW M5', '2022-05-13', 'Diesel', 1, 1, NULL, SYSDATE(6), SYSDATE(6))
        ,('UU-HH-JK', 'M.A.N', '2017-12-03', 'Diesel', 1, 1, NULL, SYSDATE(6), SYSDATE(6))
        ,('ST-FZ-28', 'Citroën', '2018-01-20', 'Elektrisch', 1, 1, NULL, SYSDATE(6), SYSDATE(6))
        ,('123-FR-T', 'Piaggio ZIP', '2021-02-01', 'Benzine', 1, 1, NULL, SYSDATE(6), SYSDATE(6))
        ,('DRS-52-P', 'Vespa', '2022-03-21', 'Benzine', 1, 1, NULL, SYSDATE(6), SYSDATE(6))
        ,('STP-12-U', 'Kymco', '2022-07-02', 'Benzine', 1, 1, NULL, SYSDATE(6), SYSDATE(6))
        ,('45-SD-23', 'Renault', '2023-01-01', 'Diesel', 1, 1, NULL, SYSDATE(6), SYSDATE(6));
